      ...
      <Grid style={{ padding: "50px" }} container spacing={3}>
        ...
        <Grid style={{ flexBasis: "auto" }} item s>
          <BlogPost
            ...
            description="Powershell is a task based command-line shell and scripting language built on .NET. Its used to help system admins and power users rapidly automate tasks which manage operating systems and processes. Many developers have little to no experience using Windows Powershell. Some believe it to believe it is simply a “crappy windows shell” as one of my colleagues had mentioned once. However, its an amazing tool for system administrators and can really step up strength as an admin and save them tons of time..."
          />
        </Grid>
        <Grid style={{ flexBasis: "auto" }} item s>
          <BlogPost
